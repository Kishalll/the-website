        ...
        >
            ...
            <div className="max-w-4xl mx-auto relative z-20">
                ...
                <motion.div
                    ...
                    className="flex flex-col md:flex-row items-center gap-8 p-8 md:p-10 rounded-2xl border border-white/10 bg-gradient-to-b from-white/10 to-black/30 backdrop-blur-md mb-12 shadow-2xl"
                >
                    {/* Avatar */}
                    <div className="w-36 h-36 md:w-44 md:h-44 rounded-full bg-neutral-800 border-2 border-white/20 overflow-hidden relative shrink-0 shadow-lg">
                        {person.image ? (
                ...
                {person.note && (
                    <motion.div
                        ...
                        className="p-8 rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-black/20 backdrop-blur-sm mb-10 relative overflow-hidden"
                    >
                ...
                {person.contributions && person.contributions.length > 0 && (
                    <motion.div
                        ...
                        className="p-8 rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-black/20 backdrop-blur-sm"
                    >
